...
- **Ajustes** — rigor da curadoria com a taxa ao lado do controle que a altera, nichos com os dois lados da ligação produto↔canal, e marketplaces com credencial, comissão por nicho e retenção de preço.
...
| O quê | Depende de |
|---|---|
| Modelos de mensagem e login | nada — é o próximo trabalho |
