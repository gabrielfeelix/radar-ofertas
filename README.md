...
- **Ajustes** — rigor da curadoria, com a taxa de aprovação ao lado do controle que a altera, e nichos, com os dois lados da ligação produto↔canal.
...
| O quê | Depende de |
|---|---|
| Marketplaces e modelos de mensagem | nada — é o próximo trabalho |
