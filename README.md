...
- **Telas de decisão** — aprovar (com painel de detalhe), publicar, canais e precisa de atenção, sobre uma **operação simulada** (D-026). Servem para testar o fluxo com gente de verdade antes de existir credencial, domínio e canal; o backend é plugado depois, ação por ação. A faixa "operação simulada" fica visível o tempo todo.
...
| O quê | Depende de |
|---|---|
| Trilha de arranque, catálogo, nichos e curadoria | nada — é o próximo trabalho |
